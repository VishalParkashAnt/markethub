 ...
 */
  ...
  class CaptchaComponent extends Component	{
    ...
    public function beforeRender() {
      //  $this->Controller->helpers['Captcha'] = array_merge($this->__getSettings(), array('controller'=>$this->Controller->request->params['controller'], 'action'=>'users/captcha'));
       if($this->request->params['prefix'] == "users") {
