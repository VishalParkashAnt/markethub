						  ...
						  <div class="hide_mobile_cart row hor-padding">
							...
							?>
								...
								<div class="text-right col-xs-12 col-sm-4 col-md-4 col-lg-4 no-hor-padding" id="total_section">
										...
										<span class="discountotal red-txt">
										<?php echo '<div style="direction:LTR">'.'-'.$giftamou;?>
										<!--CONVERT CURRENCY STARTS-->
										<?php
												if(isset($_SESSION['currency_code']))
												{
        ...
        <?php }?>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 mobile_first padding_ship_address">
				...
				<div class="white_bg">
					...
					<?php 
					if($soldout=='0' && $setgiftcard=='0' && $setcreditamount=='0') { $couponstyle="display:block"; } else { $couponstyle="display:none"; } ?>
					  ...
					  ?>
					   <?php if(!isset($getcouponvalue) && $soldout=='0' && $setcreditamount=='0') { $giftcardstyle="display:block;padding-bottom:20px;"; } else { $giftcardstyle="display:none;padding-bottom:20px"; } ?>
