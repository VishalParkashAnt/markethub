        ...
        <?php } ?>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 mobile_first padding_ship_address">
					...
					<h4 class="bold-font margin-top0"><?php echo __d('user','Ship to');?></h4>
						...
						<?php
							if($default_count==0) { ?>
								...
								<a id="ship" href="<?php echo $baseurl; ?>addaddress"><?php echo __d('user','Add Shipping Address');?></a></div>
							<?php
							}
							else{
							?>
						...
						?>
						<div class="centered-text font_size13 margin-top30 margin_bottom_mobile20">
						<a id="ship" href="<?php echo $baseurl; ?>addaddress"><?php echo __d('user','Add Shipping Address');?></a>
				...
				<div class="white_bg">
					...
					<?php if($allproductship==0 && $soldout=='0') { $couponstyle="display:block;padding-bottom:20px"; } else { $couponstyle="display:block;padding-bottom:20px"; } ?>
					  ...
					  <div class="panel panel-default applygiftcard" style="<?php echo $giftcardstyle;?>">
						...
						<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
						   <div class="panel-body padding-top0">
							<input class="form-control font_size13 margin-bottom10" id="giftcode" 
					   ...
					   <?php if($allproductship=='0' && $soldout=='0') { $applycreditamount="display:block;padding-bottom:20px"; } else { $applycreditamount="display:block;padding-bottom:20px"; } ?>
