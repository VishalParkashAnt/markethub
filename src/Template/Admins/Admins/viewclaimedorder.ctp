...
/*if($shareamount > 0){
	...
	echo '
	<tr class="ver_border padding_top10"><td align="left"><p class="gtotal">'.__d('admin', 'Grand Total').'</p></td><td style="width:50px;"></td><td align="right"><p class="gtotal"><b>'.$gtotal_admin_dis.' '.$orderCurrency.'</b></p></td></tr>
