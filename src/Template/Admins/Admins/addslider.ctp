				...
				<div class="row-fluid">
					<div class="box span12">
						<div class="box-content">
							...
							<div class="col-md-6">
							<div class="form-group">';
							echo $this->Form->input('slider_Type', array('options' => $s_options,'id'=>'slidertype','class'=>'form-control slidereffect'));
							echo '</div></div></div>';
							?>
							...
							<div class="form-group">
								...
								<?php
									...
									{
										echo '<option value="'.$eachCategory['id'].'">'.$eachCategory['category_name'].'</option>';
									}
								?>
									</select>
								</div>
							...
							<div class="form-group">
								...
								<?php
									...
									{
										echo '<option value="'.$eachCategory['id'].'">'.$eachCategory['item_title'].'</option>';
									}
								?>
									</select>
								</div>
						...
						<div class="customslider">
							<P class="widgettophead" style="display: none;"><?php echo __d('admin', 'Custom Sliders Already Active'); ?></P>
