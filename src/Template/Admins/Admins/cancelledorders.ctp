							...
							if(count($getitemuser->toArray())!=0)
							{
								foreach($getitemuser as $key=>$user_det){
									...
									echo '<tr id="del_'.$id.'">';
                                        ...
                                        if($order_totalcost[$id] == 0)
                                        {
                                            $uer_paid_amount = $user_det['discount_amount'];
                                        }else{
                                            $uer_paid_amount = $order_totalcost[$id];
                                        }
										...
										<?php
                                            ...
                                            if(strtolower($order_delivery_type[$id])!="cod") {
                                        ...
                                        /*}
                                         ...
                                         echo '<input type="button" class="btn btn-primary claimedord" disabled="disabled" style="width: 65px; font-size: 11px;" value="'.__d('admin', 'Refund').'" onclick="refundorderamount(2,'.$id.')"/>';
                                        }*/
                                    }
                                        echo '</td>';
