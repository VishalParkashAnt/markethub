					...
					<tr>
						...
						<td class="lastmoreoptiontd" style="width:130px !important;">
							<div class="moreactionmyord">
								...
								<div class="moreactionlistmyord moreactionlistmyord<?php echo $orderid; ?>" style="margin-left:-12%;">
...
<li class="moreactionsli curpoint" onclick="markprocess('<?php echo $orderid; ?>','Track')"><?php echo __d('merchant','Mark Shipped');?></li>
										...
										<?php } 
											if ($orderDetail['status'] != 'Delivered' && $orderDetail['status'] != 'Paid' && $orderDetail['status'] == 'Shipped') {
										?>
										<li class="moreactionsli curpoint" onclick="markprocess('<?php echo $orderid; ?>','Track')"><?php echo __d('merchant','Edit Tracking');?></li>
										<?php } ?>
